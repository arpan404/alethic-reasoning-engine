...
from sqlalchemy import String, BigInteger, DateTime, func, Text, Boolean, ForeignKey, Integer, Numeric, Enum as SQLEnum
...
class InterviewFeedback(Base):
    ...
    recommendation: Mapped[str | None] = mapped_column(String(50))  # strong_yes, yes, maybe, no, strong_no
...
class InterviewQuestion(Base):
    ...
    difficulty_level: Mapped[str | None] = mapped_column(String(20))  # easy, medium, hard
