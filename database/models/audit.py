...
from sqlalchemy import String, BigInteger, DateTime, func, Text, ForeignKey, JSON, Enum as SQLEnum
...
class AIDecisionLog(Base):
    ...
    review_outcome: Mapped[str | None] = mapped_column(String(50))  # approved, rejected, modified
