...
from sqlalchemy import String, BigInteger, DateTime, func, Text, Boolean, ForeignKey, Integer, Numeric, JSON
...
class VideoInterview(Base):
    ...
    meeting_platform: Mapped[str | None] = mapped_column(String(50))  # zoom, teams, google_meet
    ...
    enable_sentiment_analysis: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    enable_keyword_extraction: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class VideoAnalysis(Base):
    ...
    # Sentiment analysis
    overall_sentiment: Mapped[str | None] = mapped_column(String(50))  # positive, neutral, negative
    sentiment_score: Mapped[float | None] = mapped_column(Numeric(5, 4))  # -1.00 to 1.00
    ...
    average_response_time: Mapped[float | None] = mapped_column(Numeric(10, 2))  # seconds
...
class VideoHighlight(Base):
    ...
    # Importance
    importance_score: Mapped[float | None] = mapped_column(Numeric(3, 2))  # 0.00 to 1.00
