...
from sqlalchemy import String, BigInteger, DateTime, func, Text, ForeignKey, Integer, Boolean, Numeric
...
class Embedding(Base):
    ...
    source_text_hash: Mapped[str | None] = mapped_column(String(64), index=True)  # SHA-256 hash
...
class SimilarityCache(Base):
    ...
    similarity_method: Mapped[str] = mapped_column(String(50), nullable=False)  # cosine, euclidean, dot_product
